...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                {!! Form::open(['url' => 'admin/seo/store', 'class'=>'form-horizontal']) !!}

                <div class="form-group{{ $errors->has('meta_name') ? ' has-error' : '' }}">
                    <label for="meta_name" class="col-md-4 control-label">Name</label>

                    <div class="col-md-6">
                        <input id="meta_name" type="text" class="form-control" name="meta_name" value="{{ old('meta_name') }}" required autofocus>
                ...
                <div class="form-group{{ $errors->has('meta_body') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <textarea rows="7" id="meta_body" class="form-control" name="meta_body" value="{{ old('meta_body') }}" required autofocus></textarea>
